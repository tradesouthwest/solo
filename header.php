...
<body <?php body_class(); ?>>
    <?php wp_body_open(); ?>
    <a class="skip-link screen-reader-text" href="#sitecontent">
        <?php esc_html_e( 'Skip to content', 'solo' ); ?></a>

    <div class="page-wrap"><!-- ends in footer -->
        ...
        <header class="page-header">
            ...
            <div class="nav-container">
               <div class="nav-button-wrapper">
                    ...
                    <nav class="page-nav-wrapper" style="">
